          ...
          <Col xs={12} md={7} className='text-start testimonial-card-right'>
            <div className="testimonial-text">
              ...
              <p className="testimonial-quote mb-4">
                In the end, GuiTara Group made sustainable improvements to our business lead gen strategy. We no longer conduct any door-knocking for prospecting, which frees up time for higher-value tasks.
              </p>
              
              <p className="testimonial-quote">
                GuiTara Group all-inclusive telemarketing and digital marketing solution also provided us a reliable source of high-quality leads, which allowed our sales reps to accelerate their goals.
              </p>
            </div>
          </Col>
        </Row>
