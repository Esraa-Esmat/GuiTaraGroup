...
import GuiTaraGroupImage from '../../assets/images/home-slider-slide-2.png';
import logo2 from '../../assets/images/logo-default-143x27.png';
                ...
                <TrackVisibility>
                    {({ isVisible }) => (
                        <Row className={isVisible ? "animate__animated animate__fadeIn text-center" : "text-center"}>
                            <Col xs={12}>
                                <img src={GuiTaraGroupImage} alt="Lead Bull" className="img-fluid" />
                            </Col>
                            <Col xs={12}>
