    ...
    return (
        ...
        <section className="approach">
            ...
            <div className="approachList m-auto" style={{ font: 'Roboto Flex' }}>
                <p className=' text-center'>By offering tailored telemarketing and digital marketing solutions that are designed to meet the unique needs of each client, GuiTara Group LLC</p>
